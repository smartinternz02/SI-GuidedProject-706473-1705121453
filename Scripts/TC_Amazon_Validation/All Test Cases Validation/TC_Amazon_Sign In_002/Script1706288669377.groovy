...
WebUI.setText(findTestObject('Object Repository/Amazon_Sign In_OR/Page_Amazon Sign-In/input_email'), 'yagnasaipravallika_jonnakuti@srmap.edu.in')

WebUI.click(findTestObject('Object Repository/Amazon_Sign In_OR/Page_Amazon Sign-In/inputcontinue'))

WebUI.setEncryptedText(findTestObject('Object Repository/Amazon_Sign In_OR/Page_Amazon Sign-In/input_password'), 'Ik2pOVsVz9DFZgseKHvfYQ==')
